...
const Register = () => {
    ...
    return (
        <div className="max-w-md mx-auto p-6">
            <h2 className="text-2xl mb-3 mt-10 text-center">Załóż konto</h2><div className="flex justify-center m-3">
            ...
            <div className="mt-4 flex justify-between">
                <Link to="/login" className="w-1/2 mr-2 py-2 px-4 bg-white text-black border border-solid border-black hover:bg-gray-300 text-center">Zaloguj się</Link>
                <button 
                    type="submit" 
                    form="registerForm" 
